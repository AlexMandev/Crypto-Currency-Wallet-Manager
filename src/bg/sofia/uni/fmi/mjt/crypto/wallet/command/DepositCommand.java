...
public class DepositCommand extends Command {
    ...
    private static final int DEPOSIT_ARGUMENTS_COUNT = 1;
    private static final String INVALID_AMOUNT_MESSAGE = "The deposit amount must be a valid positive number.";
    private static final String INSUFFICIENT_ARGUMENTS_MESSAGE = "You need to specify an amount to deposit.";
    private static final String SUCCESSFUL_DEPOSIT_MESSAGE = "Deposit successful.";
    ...
    public DepositCommand(String[] arguments, SelectionKey selectionKey) {
    ...
    public String execute() {
        ...
        return SUCCESSFUL_DEPOSIT_MESSAGE + BALANCE + user.getWallet().getBalance();
    }
    ...
    public void validateArguments() {
        ...
        if (arguments.length != DEPOSIT_ARGUMENTS_COUNT) {
